...
\end{verbatim}
Jak widać, są zgodne z oczekiwaniami. Co więcej, całkiem dobrze do gruszki dopasowała się papryka, co jest nawet zgodne z intuicją - gruszka i papryka mają, z grubsza, podobny kształt.
Oba dopasowania przedstawione są na rysunku 5.

\paragraph{Ananas}
Wzbudzającym kontrowersje jest próba odpowiedzi, do którego z owoców podobny jest ananas (zapytaniem jest pineapple3).
Jasnym jest, że poprawną odpowiedzią jest: ananas. Okazuje się, że nawet dla bardzo, wizualnie, podobnych ananasów, program daje zaskakujące wyniki.
Oto wynik działania:
\begin{verbatim}
...
\end{verbatim}
Najlepsze dopasowanie obrazków pineapple i pineapple3 przedstawione jest na rysunku 6. Dopasowały się.. do góry nogami! Wyjaśnienie tego faktu jest proste, jak spojrzymy na drugą część
Rysunku 6, przedstawiającego punkty charakterystyczne. Ich zbiór okazuje się być niemalże symetryczny - co prowadzi do tak zaskakujących wyników.

\subsection{Trzyliterówki}
Teraz przedstawimy wyniki kilku eksperymentów polegających na rozpoznaniu
...
\begin{figure}\centering
\subfloat[Gruszka i Gruszka]{\includegraphics[width=5cm,keepaspectratio=true]{./diff_pear.png}}
\subfloat[Gruszka i Papryka]{\includegraphics[width=5cm,keepaspectratio=true]{./diff_paprika.png}}
\caption{Dopasowania \texttt{pear} i \texttt{paprika} do \texttt{pear2}}
\end{figure}
