...
Okazuje się, że nawet w przypadku nawet niemal identycznych obrazków, ich POI nie będą idealnie się pokrywały. Wynika to z między innymi z specyfiki algorytmu oceny
...
\[ d' = \begin{cases}
	    d & \text{jeżeli } d_0 < \mathrm{avg}_t / 2 \\
...
\subfloat[screenshot z wyników]{\includegraphics[width=5cm,keepaspectratio=true]{./test1/result.png}}
