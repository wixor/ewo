...
Przedstawione podejście może nasuwać dwa pytania. Po pierwsze, co należy zrobić, jeżeli chcemy znać najbliższy punkt dla punktu, którego współrzędne nie są całkowite (jest to normalne zjawisko, gdyż
...
\paragraph{Test niedziałający: 2, 3, 6}
W niniejszym teście będziemy starali się rozpoznać, co jest przedstawione na mozaice złożonej z kilku cyfr. Warto wspomnieć, że każdy z elementów mozaiki z osobna dobrze bądź idealnie dopasowuje się do
...
\end{verbatim}
Patrząc na obrazki, można dostrzec przeszkody, o których pisaliśmy w podrozdziale 4.2. Przeanalizujmy kolejne próby dopasowań.

Dwójka i trójka są klasycznymi świadectwami przeszkody czwartej - w szóstce łatwo znaleźć fragment, który wygląda jak 2 albo 3.
Czwórka jest przykładem na przeszkodę drugą (łatwiej było dopasować cyfrę ściśniętą maksymalnie w granicach, o których była mowa w tymże podrozdziale).
Natomiast szóstka świadczy o tym, że pomimo że poradziliśmy sobie z przeszkodą trzecią (mianowicie, wystające poza obrys szóstki na mozaice fragmenty cyfry dostały wysoką karę)
nie potrafiliśmy wyrwać się z tego maksimum lokalnego -- najprawdopodobniej dobrym rozwiązaniem okazałoby się dopracowanie równań opisujących zmienne parametry ewolucji.
